...
def do_generate_plots(image_dir, test_name, datatype, dimensions, phi, Sigma, data,
                      data_gt, n_eigenvectors, info, all_corrs, corr_thresh, C):
  print("\nGenerating plots...")
...
def main():
  ...
  if generate_plots:
    image_dir = './images/'
    do_generate_plots(image_dir, test_name, datatype, dimensions, phi, Sigma, data,
                      data_gt, n_eigenvectors, info, all_corrs, corr_thresh, C)
